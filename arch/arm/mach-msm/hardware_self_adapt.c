...
extern int hasCompass ;
/*hasCompass is a flag to note if has Compass,U8655N doesn't have*/
static int get_sensors_list(void)
{
	...
	/*add M866*/
    /* U8665 version E remove compass */
	/* Add U8685D & C8685D */
	/* Add U8685 */
    if( machine_is_msm7x27a_U8661() || ( machine_is_msm7x27a_C8820() && (HW_VER_SUB_VC <= get_hw_sub_board_id()))
          ...
          || ( machine_is_msm7x27a_U8655_EMMC() && (HW_VER_SUB_VE == get_hw_sub_board_id())) 
		  || ( machine_is_msm7x27a_U8655() && (!hascompass)) )
    {
        sensors_list = G_SENSOR + L_SENSOR + P_SENSOR;
		printk("####This device doesn't own compass\n");
    }
    else if ((machine_is_msm7x27a_U8655() && hascompass) ||
    ...
    /* U8685D,C8685D,U8685-1,U8685-51 do not have light sensor and proximity sensor */
...
hw_ds_type get_hw_ds_type(void)
{
    ...
    if( machine_is_msm7x27a_C8820()
      ...
      || machine_is_msm7x27a_U8685D()
      || machine_is_msm7x27a_C8685D()
      /*U8685-1/U8685-51 only have one sim card,the ret should be HW_NODS,delete machine_is_msm7x27a_U8685 here*/
	  || machine_is_msm7x27a_C8668D())
    {
	    ret = HW_DS;
    }
...
/* add c8655v for SINGLE_MIC */
/* add c8655 for SINGLE_MIC */
/* add U8685D for SINGLE_MIC */
audio_property_type get_audio_mic_type(void)
{
  if(machine_is_msm7x27a_U8185() || machine_is_msm7x27a_U8661()
     || (machine_is_msm7x27a_C8820() && (HW_VER_SUB_VC <= get_hw_sub_board_id()))
     || (machine_is_msm7x27a_C8655_NAND() && (HW_VER_SUB_VF == get_hw_sub_board_id()))
     || (machine_is_msm7x27a_C8655_NAND() && (HW_VER_SUB_VA == get_hw_sub_board_id()))
     || (machine_is_msm7x27a_C8655_NAND() && (HW_VER_SUB_VB == get_hw_sub_board_id()))
