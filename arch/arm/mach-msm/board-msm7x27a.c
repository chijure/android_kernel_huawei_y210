...
compass_gs_position_type  get_compass_gs_position(void)
{
    ...
    /* U8685D,C8685D,U8685-1,U8685-51 don not have the compass */
...
static void *ar6k_dma_buffer_pointer = NULL;
...
static int __init msm7x27a_init_ath_buf(void)
{
    ...
    {
        pr_err("%s:  No buffer for ar6k_dma_buffer_pointer. \n", __func__);
        return -ENOMEM;
    }
...
/*
* return the memory preallocated in msm7x27a_init_ath_buf()
*/
...
static int msm_sdcc_setup_vreg(int dev_id, unsigned int enable)
{
	...
	if (enable) {
		 ...
		 * To fix the M660 muvemusic init slowly issue when phone wake up.
		 */
#ifdef CONFIG_HUAWEI_KERNEL
...
static struct snd_endpoint snd_endpoints_list[] = {
	...
	SND(SPEAKER_HEADSETMIC, 38),
	SND(HANDSET_HEADSETMIC, 39),
	SND(HEADSET_MAINMIC, 40),
	SND(HEADSET_SECMIC, 41),
	SND(HEADSET_HEADSETMIC, 42),
};
#undef SND
...
static struct msm_camera_sensor_platform_info hi255_sensor_info = {
	.mount_angle = 90
};

static struct msm_camera_sensor_flash_data flash_hi255 = {
	.flash_type = MSM_CAMERA_FLASH_LED,
	.flash_src  = &msm_flash_src
};

static struct msm_camera_sensor_info msm_camera_sensor_hi255_data = {
	.sensor_name    =(char*)back_camera_name,
	.sensor_reset   = 49,
	.sensor_reset_enable = 1,
	.sensor_pwd     = 119,
	...
	.vcm_enable     = 1,
	.pdata          = &msm_camera_device_data_rear,
	.flash_data     = &flash_hi255,
	.sensor_platform_info   = &hi255_sensor_info,
	.s5k5ca_or_mt9t113_on      = camera_s5k5ca_or_mt9t113_is_on,
	.csi_if         = 1,
	.vreg_enable_func = msm_camera_vreg_config,
	.vreg_disable_func = msm_camera_vreg_config,
...
static struct platform_device msm_camera_sensor_hi255 = {
	.name      = "msm_camera_hi255",
	.dev       = {
		.platform_data = &msm_camera_sensor_hi255_data,
	},
};
#endif
...
#endif
#ifdef CONFIG_HUAWEI_CAMERA_SENSOR_OV5647
static struct msm_camera_sensor_platform_info ov5647_sensor_info = {
	.mount_angle = 90,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov5647_data = {
	...
	.sensor_platform_info   = &ov5647_sensor_info,
	.csi_if         = 1,
	.vreg_enable_func = msm_camera_vreg_config,
	.vreg_disable_func = msm_camera_vreg_config,
	.slave_sensor   = 0
...
static void camera_sensor_pwd_config(void)
{
	...
	if(LCD_IS_RGB == get_hw_lcd_interface_type())
	{
		...
		msm_camera_sensor_hi255_data.sensor_pwd = gpio_pwd;
		msm_camera_sensor_hi255_data.sensor_pwd = gpio_pwd;
	}
}
#endif
...
MACHINE_START(MSM7X27A_C8668D, "MSM7x27a Y210 BOARD")
	...
	.init_early     = msm7x2x_init_early,
MACHINE_END
MACHINE_START(MSM7X27A_U8685D, "MSM7x27a Y210-0010 BOARD")
	.boot_params	= PHYS_OFFSET + 0x100,
	.map_io		= msm_common_io_init,
	.reserve	= msm7x27a_reserve,
	.init_irq	= msm_init_irq,
...
MACHINE_START(MSM7X27A_C8685D, "MSM7x27a Y210-2010 BOARD")
	.boot_params	= PHYS_OFFSET + 0x100,
	.map_io		= msm_common_io_init,
	.reserve	= msm7x27a_reserve,
	.init_irq	= msm_init_irq,
	...
	.init_early     = msm7x2x_init_early,
MACHINE_END
MACHINE_START(MSM7X27A_U8685, "MSM7x27a U8685 BOARD")
	.boot_params	= PHYS_OFFSET + 0x100,
	.map_io		= msm_common_io_init,
	.reserve	= msm7x27a_reserve,
	.init_irq	= msm_init_irq,
